...
namespace SPBackend.Migrations
{
    ...
    [Migration("20260404230751_PricePerConsumption")]
    partial class PricePerConsumption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPBackend.Models.Plug", b =>
                {
                    ...
                    b.Property<double?>("ConstantConsumption")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("SPBackend.Models.PowerSourceSession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SPBackend.Models.PlugPolicy", b =>
                {
                    ...
                    b.HasOne("SPBackend.Models.Policy", "Policy")
                        .WithMany("PlugPolicies")
